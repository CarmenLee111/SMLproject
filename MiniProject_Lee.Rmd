...
for (i in 1:N.cv)
{
  ...
  glm.model <- glm(formula = label ~ danceability+energy+speechiness+acousticness+instrumentalness+valence+tempo+key+liveness+loudness+duration, data = training.data, family = binomial)
  ...
  lda.model <- lda(formula = label ~ danceability+energy+speechiness+acousticness+instrumentalness+valence+tempo+key+liveness+loudness+duration, data = training.data)
  ...
  qda.model <- qda(formula = label ~ danceability+energy+speechiness+acousticness+instrumentalness+valence+tempo+key+liveness+loudness+duration, data = training.data)
  ...
  training.data.knn = data.frame(training.data$danceability, training.data$energy, training.data$speechiness, training.data$acousticness, training.data$instrumentalness, training.data$valence, training.data$tempo, training.data$key, training.data$liveness, training.data$loudness, training.data$duration)
  validation.data.knn = data.frame(validation.data$danceability, validation.data$energy, validation.data$speechiness, validation.data$acousticness, validation.data$instrumentalness, validation.data$valence, validation.data$tempo, validation.data$key, validation.data$liveness, validation.data$loudness, validation.data$duration)
